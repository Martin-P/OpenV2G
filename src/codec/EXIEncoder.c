...
int exiEncodeStartElement(bitstream_t* stream, exi_state_t* state, eqname_t* se) {
	switch (state->grammarStack[state->stackIndex]) {
		...
		if ( se->localPart == 0 && se->namespaceURI == 6  ) {
			...
			return _exiEncodeStartElement(stream, 7, 8, state, se, 2, 88);
		}
			...
			return _exiEncodeStartElement(stream, 7, 10, state, se, 2, 116);
		}
		...
		else if ( se->localPart == 111 && se->namespaceURI == 5 ) {
	...
	case 89:
		...
		if ( se->localPart == 83 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ResponseCode ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 90, 58);
		}
		break;
	case 90:
	...
	case 91:
		...
		if ( se->localPart == 32 && se->namespaceURI == 5  ) {
			...
			return _exiEncodeStartElement(stream, 1, 0, state, se, 99, 100);
		}
		break;
	case 92:
		...
		if ( se->localPart == 8 && se->namespaceURI == 6  ) {
			...
			return _exiEncodeStartElement(stream, 1, 0, state, se, 93, 79);
		}
		break;
	case 93:
		...
		if ( se->localPart == 141 && se->namespaceURI == 6  ) {
			...
			return _exiEncodeStartElement(stream, 2, 0, state, se, 94, 95);
		}
		break;
	case 95:
		/* FirstStartTag[START_ELEMENT({urn:iso:15118:2:2010:MsgDataTypes}Certificate)] */ 
	...
	case 96:
		...
		if ( se->localPart == 8 && se->namespaceURI == 6  ) {
			/* SE( {urn:iso:15118:2:2010:MsgDataTypes}Certificate ) */
			return _exiEncodeStartElement(stream, 2, 0, state, se, 96, 79);
		}
		break;
	case 97:
	...
	case 99:
		...
		if ( se->localPart == 29 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ContractEncryptionEncryptedPrivateKey ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 102, 100);
		}
		break;
	case 102:
	...
	case 110:
		...
		if ( se->localPart == 31 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ContractSignatureCertChain ) */
			return _exiEncodeStartElement(stream, 2, 1, state, se, 112, 92);
		}
		break;
	case 111:
		...
		if ( se->localPart == 31 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ContractSignatureCertChain ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 112, 92);
		}
		break;
	case 112:
		/* Element[START_ELEMENT({urn:iso:15118:2:2010:MsgBody}ContractID)] */ 
	...
	case 117:
		...
		if ( se->localPart == 83 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ResponseCode ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 118, 58);
		}
		break;
	case 118:
		/* Element[START_ELEMENT({urn:iso:15118:2:2010:MsgBody}ContractSignatureCertChain)] */ 
		if ( se->localPart == 31 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ContractSignatureCertChain ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 119, 92);
		}
		break;
	case 119:
		/* Element[START_ELEMENT({urn:iso:15118:2:2010:MsgBody}ContractSignatureEncryptedPrivateKey)] */ 
		if ( se->localPart == 32 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ContractSignatureEncryptedPrivateKey ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 120, 100);
		}
		break;
	case 120:
		/* Element[START_ELEMENT({urn:iso:15118:2:2010:MsgBody}ContractEncryptionEncryptedPrivateKey)] */ 
		if ( se->localPart == 29 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ContractEncryptionEncryptedPrivateKey ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 121, 100);
		}
		break;
	case 121:
		/* Element[START_ELEMENT({urn:iso:15118:2:2010:MsgBody}DHParams)] */ 
		if ( se->localPart == 39 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}DHParams ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 122, 104);
		}
		break;
	case 122:
		/* Element[START_ELEMENT({urn:iso:15118:2:2010:MsgBody}ContractID)] */ 
	...
	case 224:
		...
		if ( se->localPart == 85 && se->namespaceURI == 5  ) {
			...
			return _exiEncodeStartElement(stream, 1, 0, state, se, 227, 152);
		}
		break;
	case 227:
	...
	case 228:
		...
		if ( se->localPart == 60 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}MeterInfo ) */
	...
	case 264:
		...
		else if ( se->localPart == 81 && se->namespaceURI == 5 ) {
	...
	case 276:
		...
		else if ( se->localPart == 50 && se->namespaceURI == 5 ) {
	...
	case 385:
		...
		if ( se->localPart == 85 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}SAScheduleTupleID ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 388, 152);
		}
		break;
	case 388:
	...
	case 403:
		...
		if ( se->localPart == 31 && se->namespaceURI == 5  ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ContractSignatureCertChain ) */
			return _exiEncodeStartElement(stream, 1, 0, state, se, 404, 92);
		}
		break;
	case 405:
		/* Element[START_ELEMENT({urn:iso:15118:2:2010:MsgBody}ContractID)] */ 
	...
	case 466:
		...
		if ( se->localPart == 99 && se->namespaceURI == 5  ) {
	...
	case 590:
		...
		if ( se->localPart == 2 && se->namespaceURI == 7  ) {
			...
			/* SE( {urn:iso:15118:2:2010:MsgBody}CertificateInstallationRes ) */
			return _exiEncodeStartElement(stream, 6, 4, state, se, 591, 88);
		}
		else if ( se->localPart == 10 && se->namespaceURI == 5 ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}CertificateUpdateReq ) */
			...
			/* SE( {urn:iso:15118:2:2010:MsgBody}CertificateUpdateRes ) */
			return _exiEncodeStartElement(stream, 6, 6, state, se, 591, 116);
		}
		else if ( se->localPart == 14 && se->namespaceURI == 5 ) {
			/* SE( {urn:iso:15118:2:2010:MsgBody}ChargeParameterDiscoveryReq ) */
