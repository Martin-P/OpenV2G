...
static int deserializeElementAttributeCharacter(struct EXIService* service)
{
	...
	switch(service->eqn.namespaceURI) {
		...
		case 5:
			switch(service->eqn.localPart) {
				case 83: /*ResponseCode*/

					if(service->val.type == ENUMERATION)
						{
							if( service->idPath.id[2] == 108)
							{
							...
							} else if(service->idPath.id[2] == 95)
							{
							...
							} else if(service->idPath.id[2] == 91)
							{
							...
							} else if(service->idPath.id[2] == 68)
							{
							...
							} else if(service->idPath.id[2] == 73)
							{
							...
							} else if(service->idPath.id[2] == 111)
							{
							...
							} else if(service->idPath.id[2] == 116)
							{
				...
				break;
				case 32: /*ContractSignatureEncryptedPrivateKey*/
				...
				break;
				case 29: /*ContractEncryptionEncryptedPrivateKey*/

				if(service->val.type == BINARY_BASE64) 
					{
						if( service->idPath.id[2] == 12)
						{
							memcpy(service->exiMsg.V2G_Message.Body.CertificateUpdateRes->ContractEncryptionEncryptedPrivateKey.data, service->val.binary.data,service->val.binary.len);
						service->exiMsg.V2G_Message.Body.CertificateUpdateRes->ContractEncryptionEncryptedPrivateKey.arraylen.data = service->val.binary.len;

						} else if(service->idPath.id[2] == 8)
						{
							memcpy(service->exiMsg.V2G_Message.Body.CertificateInstallationRes->ContractEncryptionEncryptedPrivateKey.data, service->val.binary.data,service->val.binary.len);
						service->exiMsg.V2G_Message.Body.CertificateInstallationRes->ContractEncryptionEncryptedPrivateKey.arraylen.data = service->val.binary.len;
						}
				...
				break;
				case 46: /*EVSECurrentLimitAchieved*/
				...
				break;
				case 55: /*EVSEVoltageLimitAchieved*/
				...
				break;
				case 52: /*EVSEPowerLimitAchieved*/
				...
				if(service->val.type == NBIT_UNSIGNED_INTEGER) 
					{
						...
						} else if(service->idPath.id[3] == 54 && service->idPath.id[2] == 116)
						{
